...
<div class="detail-hero">
  <div class="container mx-auto px-4">
    <div style="display:flex;align-items:center;gap:8px;color:#64748B;font-size:.85rem;margin-bottom:20px;">
      ...
      <a href="{{ url('/cars') }}" style="color:#64748B;transition:.2s;" onmouseover="this.style.color='#D4AF37'" onmouseout="this.style.color='#64748B'">Car</a>
      <i class="fas fa-chevron-right" style="font-size:.65rem;"></i>
  ...
  <div class="detail-grid">
    ...
    <div>
      ...
      <div class="car-info-card">
        ...
        <p class="desc-text" style="margin-top:12px;">Our Car is always in prime condition, professionally cleaned before handover, and ready for pickup or delivery to your location.</p>
      </div>
    </div>
