...
@section('title', 'Car Scheduling – Siliwangi Admin')
...
<div class="page-header">
    <div>
        <h1 style="font-size: 24px; font-weight: 800; font-family: 'Poppins', sans-serif; color: var(--text-main); margin-bottom: 4px;">Car Scheduling</h1>
...
<div class="schedule-card">
    ...
    <div style="overflow-x: auto;">
        <table class="timeline-table">
            <thead>
                <tr>
                    <th class="car-info-cell">Car Unit</th>
                    @for($i = 0; $i < 7; $i++)
                    <th>
