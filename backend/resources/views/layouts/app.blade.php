...
<body class="antialiased overflow-x-hidden relative">
    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 transition-all duration-500 ease-in-out"
        ...
        <div x-show="open && !isDesktop"
            ...
            '/cars' => ['icon' => 'fa-car-side', 'label' => 'Car'],
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                ...
                <div class="space-y-8" data-aos="fade-up">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed font-medium">
                        Indonesia's leading premium car rental service. We deliver first-class comfort with the latest Car and professional driver services.
                    </p>
