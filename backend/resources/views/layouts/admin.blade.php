    ...
    <div class="admin-layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-menu">
                <div class="menu-label">Pusat Analisis</div>
                
                <div class="menu-item {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                    <a href="{{ route('dashboard') }}" class="menu-link">
                        <i class="fas fa-chart-line"></i>
                        <span class="text">Ringkasan Operasional</span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <a href="#" class="menu-link opacity-50" title="Business Intelligence Hub - Coming Soon">
                        ...
                        <span class="text">Analisis Pertumbuhan</span>
                    </a>
                </div>

                <div class="menu-label">Manajemen Operasional</div>
                
                <div class="menu-item {{ request()->routeIs('admin.bookings.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.bookings.index') }}" class="menu-link">
                        <i class="fas fa-calendar-check"></i>
                        <span class="text">Pemesanan & Jadwal</span>
                    </a>
                </div>

                <div class="menu-item">
                    <a href="#" class="menu-link opacity-50" title="Fitur Kondisi & Servis Mobil ditangguhkan sementara">
                        <i class="fas fa-tools"></i>
                        <span class="text">Kondisi & Servis Mobil</span>
                        <span class="badge bg-secondary ms-auto d-flex align-items-center gap-1" style="font-size: 8px; padding: 3px 6px;">
                            <i class="fas fa-lock" style="font-size: 8px;"></i> DIKUNCI
                        </span>
                    </a>
                </div>

                <div class="menu-item">
                    <a href="#" class="menu-link opacity-50" title="Fitur Pelacakan GPS Langsung ditangguhkan sementara">
                        <i class="fas fa-satellite-dish"></i>
                        <span class="text">Pelacakan GPS Langsung</span>
                        <span class="badge bg-secondary ms-auto d-flex align-items-center gap-1" style="font-size: 8px; padding: 3px 6px;">
                            <i class="fas fa-lock" style="font-size: 8px;"></i> DIKUNCI
                        </span>
                    </a>
                ...
                <div class="menu-item {{ request()->routeIs('admin.car-inspections.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.car-inspections.index') }}" class="menu-link">
                        ...
                        <span class="text">Inspeksi Kendaraan</span>
                    </a>
                </div>
                
                <div class="menu-item {{ request()->routeIs('admin.finance.payments') ? 'open active' : '' }}">
                    <div class="menu-link" onclick="toggleSubmenu(this)" style="cursor: pointer;">
                        <i class="fas fa-university"></i>
                        <span class="text">Manajemen Keuangan</span>
                        <i class="fas fa-chevron-right arrow" style="margin-left: auto; font-size: 10px;"></i>
                    </div>
                    <div class="submenu">
                        <a href="{{ route('admin.finance.payments') }}" class="submenu-link {{ request()->routeIs('admin.finance.payments') ? 'active' : '' }}">Catatan Keuangan</a>
                        <a href="#" class="submenu-link d-flex align-items-center justify-content-between">
                            <span>Gerbang Pembayaran</span>
                            <span class="badge bg-warning text-dark" style="font-size: 8px;">BETA</span>
                        </a>
                        <a href="#" class="submenu-link d-flex align-items-center justify-content-between">
                ...
                <div class="menu-label">Direktori Aset</div>

                <div class="menu-item {{ request()->routeIs('admin.cars.*') ? 'active' : '' }}">
                    <div class="menu-link" onclick="toggleSubmenu(this)" style="cursor: pointer;">
                        <i class="fas fa-car"></i>
                        <span class="text">Manajemen Mobil</span>
                        <i class="fas fa-chevron-right arrow" style="margin-left: auto; font-size: 10px;"></i>
                    </div>
                    <div class="submenu">
                        <a href="{{ route('admin.cars.index') }}" class="submenu-link {{ request()->routeIs('admin.cars.index') ? 'active' : '' }}">Daftar Kendaraan</a>
                        <a href="{{ route('admin.car-brands.index') }}" class="submenu-link {{ request()->routeIs('admin.car-brands.*') ? 'active' : '' }}">Daftar Merek</a>
                        <a href="{{ route('admin.car-types.index') }}" class="submenu-link {{ request()->routeIs('admin.car-types.*') ? 'active' : '' }}">Pengaturan Kategori</a>
                    </div>
                </div>
                ...
                <div class="menu-item {{ request()->routeIs('admin.drivers.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.drivers.index') }}" class="menu-link">
                        ...
                        <span class="text">Sopir Aktif</span>
                    </a>
                </div>
                ...
                <div class="menu-item {{ request()->routeIs('admin.customers.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.customers.index') }}" class="menu-link">
                        ...
                        <span class="text">Database Pelanggan</span>
                    </a>
                </div>

                <div class="menu-label">Laporan & Pengaturan</div>

                <div class="menu-item {{ request()->routeIs('admin.reports.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.reports.index') }}" class="menu-link">
                        <i class="fas fa-file-contract"></i>
                        <span class="text">Laporan Bisnis</span>
                    </a>
                </div>
                ...
                <div class="menu-item">
                    <div class="menu-link" onclick="toggleSubmenu(this)" style="cursor: pointer;">
                        ...
                        <span class="text">Tata Kelola Pelanggan</span>
                        <i class="fas fa-chevron-right arrow" style="margin-left: auto; font-size: 10px;"></i>
                    </div>
                    <div class="submenu">
                        <a href="#" class="submenu-link text-danger fw-bold"><i class="fas fa-user-slash me-1"></i> Daftar Hitam</a>
                        <a href="#" class="submenu-link">Program Loyalitas</a>
                        <a href="#" class="submenu-link">Pemasaran WhatsApp</a>
                    </div>
                </div>
                ...
                <div class="menu-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.users.index') }}" class="menu-link">
                        ...
                        <span class="text">Akses Sistem</span>
                    </a>
                </div>
            </div>
        </aside>
