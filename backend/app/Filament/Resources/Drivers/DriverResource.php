...
class DriverResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Driver Aktif';

    protected static ?string $pluralLabel = 'Driver Aktif';

    protected static ?string $modelLabel = 'Driver';

    protected static ?string $navigationGroup = 'Daftar Aset';
