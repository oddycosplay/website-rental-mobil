                    ...
                    ->schema([
                        Infolists\Components\Grid::make(3)
                            ->schema([
                                ...
                                Infolists\Components\TextEntry::make('sim_number')
                                    ->label('Nomor SIM')
                                    ->copyable()
                                    ->placeholder('Belum ditentukan pada requirement.'),
                                Infolists\Components\TextEntry::make('no_kk')
                                    ...
                                    ->copyable()
                                    ->placeholder('Belum ditentukan pada requirement.'),
                                Infolists\Components\TextEntry::make('nip_nim')
                ...
                Infolists\Components\Section::make('Berkas & Dokumen Verifikasi')
                    ...
                    ->schema([
                        Infolists\Components\Grid::make(2)
                            ->schema([
                                Infolists\Components\ImageEntry::make('selfie_image')
                                    ->label('Foto Selfie Renter')
                                    ->disk('public')
                                    ->size(200)
                                    ->placeholder('Tidak ada berkas.'),
                                Infolists\Components\ImageEntry::make('ktp_image')
                                    ->label('Foto KTP Resmi')
                                    ->disk('public')
                                    ->size(200)
                                    ->placeholder('Tidak ada berkas.'),
                                Infolists\Components\ImageEntry::make('sim_image')
                                    ->label('Foto SIM Resmi')
                                    ->disk('public')
                                    ->size(200)
                                    ->placeholder('Tidak ada berkas.'),
                                Infolists\Components\ImageEntry::make('kk_image')
                                    ->label('Foto Kartu Keluarga')
                                    ->disk('public')
                                    ->size(200)
                                    ->placeholder('Tidak ada berkas.'),
                                Infolists\Components\ImageEntry::make('pelajar_image')
