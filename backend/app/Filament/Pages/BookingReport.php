...
class BookingReport extends Page
{
    ...
    protected static string|\UnitEnum|null $navigationGroup = 'Dashboard & Analisis';

    protected static ?string $navigationLabel = 'Analisis Pertumbuhan';

    protected static ?string $title = 'Analisis Pertumbuhan';
