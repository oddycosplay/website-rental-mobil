...
class MidtransController extends Controller
{
    public function callback(Request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($booking, $payment, $transactionStatus, $notification) {
                // Log the notification to payment_logs JSON column
    ...
    private function updateStatus(Booking $booking, Payment $payment, string $status, object $notification)
    {
        ...
        if ($status == 'paid') {
            ...
            SendWhatsAppMessage::dispatch($customer->phone, $msg);
