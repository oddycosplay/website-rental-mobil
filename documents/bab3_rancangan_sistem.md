...
![Halaman Beranda Customer](testing/ux/Landing_Page_-_Siliwangi_Rental.png)
...
![Halaman Daftar Kendaraan](testing/ux/Fleet_Page_-_Siliwangi_Rental.png)

### 3. Rancangan Website Halaman FAQ

Menampilkan daftar pertanyaan dan jawaban yang sering diajukan oleh pelanggan.

![Halaman FAQ](testing/ux/FAQ_Page_-_High_Fidelity_Siliwangi_Rental_Revised.png)
...
![Halaman Kontak](testing/ux/UX_Wireframe_-_Contact_Page.png)
...
![Registrasi Customer](testing/ux/UX_Wireframe_-_Sign_Up_Page.png)

### 7. Rancangan Login Customer

Fitur autentikasi pengguna untuk mengakses layanan booking dan pengelolaan akun.

![Login Customer](testing/ux/UX_Wireframe_-_Login_Page.png)
...
![Booking Kendaraan](testing/ux/UX_Wireframe_-_Rental_Cart_Page.png)

### 10. Rancangan Checkout Booking

Fitur konfirmasi data pemesanan sebelum melakukan pembayaran.

![Checkout Booking](testing/ux/UX_Wireframe_-_Booking_Checkout_Page.png)

### 11. Rancangan Pembayaran Booking

Fitur pembayaran transaksi rental melalui payment gateway.

![Pembayaran Booking](testing/ux/UX_Wireframe_-_Booking_Checkout_Step_5_Pay.png)

### 12. Rancangan Invoice Pembayaran

Menampilkan detail tagihan dan bukti pembayaran pelanggan.

![Invoice Pembayaran](testing/ux/UX_Wireframe_-_Invoice_Page.png)
...
![Detail Booking](testing/ux/UX_Wireframe_-_Booking_Success_Confirmation.png)
...
![Dashboard Admin](testing/ux/UX_Wireframe_-_Admin_Dashboard.png)

### 2. Rancangan Kelola Data Kendaraan

Fitur pengelolaan data kendaraan yang tersedia pada sistem.

![Kelola Data Kendaraan](testing/ux/UX_Wireframe_-_Fleet_Management_Dashboard.png)

### 3. Rancangan Tambah Kendaraan

Fitur menambahkan data kendaraan baru.

![Tambah Kendaraan](testing/ux/UX_Wireframe_-_Create_Car_Form.png)
...
![Kelola Booking](testing/ux/UX_Wireframe_-_Booking_Intelligence_Dashboard.png)
...
![Kelola Pengeluaran Operasional](testing/ux/UX_Wireframe_-_Financial_Records_Dashboard.png)

### 20. Rancangan Dashboard Analytics

Fitur visualisasi statistik transaksi, pendapatan, dan penggunaan armada.

![Dashboard Analytics](testing/ux/UX_Wireframe_-_Booking_Intelligence_Dashboard_Regen.png)
