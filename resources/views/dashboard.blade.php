        ...
        <div class="col-xl-3 col-md-6 animate__animated animate__fadeInUp" style="animation-delay: 0.4s">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100 transition-all hov-move-up">
                <div class="card-body p-4">
                    ...
                    <h6 class="text-muted small text-uppercase fw-bold mb-1">Fleet Status</h6>
                ...
                <div class="px-4 py-3 bg-light border-top">
                    <a href="{{ route('admin.cars.index') }}" class="text-decoration-none text-info small fw-semibold">
                        Fleet Management <i class="fas fa-chevron-right ms-1 small"></i>
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5 text-muted">
                                        ...
                                        <a href="{{ route('cars.index') }}" class="btn btn-primary px-4 rounded-pill">Explore Fleet</a>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3 p-3 rounded-3 bg-light border-start border-4 border-primary">
                        <p class="small mb-0 text-muted">
                            ...
                            <strong>Insight:</strong> Booking demand is projected to peak in <strong>December</strong> and <strong>June</strong>. Consider increasing fleet readiness and adjusting pricing for peak periods.
                        </p>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize Map
    if(document.getElementById('fleetMap')) {
        const map = L.map('fleetMap', { zoomControl: false, attributionControl: false }).setView([-6.9147, 107.6098], 13);
        L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png', { maxZoom: 20 }).addTo(map);
        const fleetData = JSON.parse("{!! json_encode($gpsFleet) !!}");
        const markers = [];

        fleetData.forEach(function(car) {
