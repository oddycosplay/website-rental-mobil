...
<div class="row g-4 mb-5">
    ...
    <!-- Chart 2: Fleet Category Share (Doughnut Chart) -->
    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
        <div class="card h-100 p-4" style="background: var(--card-bg); border: 1px solid var(--card-border); border-radius: var(--radius-xl); box-shadow: var(--card-shadow); transition: var(--transition);">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 style="font-size: 16px; font-weight: 800; color: var(--text-main); margin: 0; font-family: 'Poppins', sans-serif;">
                        <i class="fas fa-chart-pie text-warning me-2"></i> Popular Fleet Demand
                    </h4>
            ...
            <div style="position: relative; height: 250px;" class="d-flex align-items-center justify-content-center">
                <canvas id="fleetShareChart"></canvas>
            </div>
...
<script>
            ...
            .then(booking => {
                ...
                timeline.innerHTML += `
                    <div class="timeline-item ${step3Class}">
                        <div class="data-value" style="font-size: 12px;">Fleet Logistics & Cycle</div>
    ...
    let fleetShareChartInstance = null;
    ...
    function initCharts(theme = 'light') {
        ...
        // Fleet Category Share Chart (Doughnut)
        const ctxFleet = document.getElementById('fleetShareChart');
        if (ctxFleet) {
            const ctx = ctxFleet.getContext('2d');
            if (fleetShareChartInstance) fleetShareChartInstance.destroy();
            
            fleetShareChartInstance = new Chart(ctx, {
                type: 'doughnut',
                data: {
